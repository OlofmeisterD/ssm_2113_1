...
<div class="right">
       ...
       <div class="search">
       <form method="post" action="${pageContext.request.contextPath }/bill/bill.do">
			<span>商品名称：</span>
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billList }" varStatus="status">
				<tr>
					...
					<td>
					<span><a class="viewBill" href="/bill/view/${bill.id}"><img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/></a></span>
					<span><a class="modifyBill" href="/bill/billmodify.html?billid=${bill.id}"><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
